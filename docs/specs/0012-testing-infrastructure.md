...
- [x] `.github/workflows/ci.yml` runs `npm run test` and a CI run on this spec's own PR shows it passing — verified on [PR #25](https://github.com/ShahArpit89/arpitshah.in/pull/25), run [35594628686](https://github.com/ShahArpit89/arpitshah.in/actions/runs/35594628686), conclusion `success`
