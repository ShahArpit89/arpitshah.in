...
**Live site:** arpitshah.in (not yet live — DNS cutover pending, see [PRD.md §7](docs/PRD.md#7-open-items--next-steps)).
...
[design/homepage-mockup.html](design/homepage-mockup.html) is the finalized visual reference; [docs/DESIGN-SYSTEM.md](docs/DESIGN-SYSTEM.md) documents the tokens, type, and component patterns extracted from it.
